# AIFENCE 0.2 Technology Compatibility Kit (TCK)
...
The same vectors live in `src/aifence/bus/tck/vectors/core.json` so installed SDKs can run them without the source checkout.
...
6. round-trip the wire object through the AIFENCE A2A 1.0 DataPart binding without changing it.
