...
docker compose -f deploy/qualification/compose.yaml up -d --build --wait --scale agentdance=3 --scale worker=3 --scale lifecycle-worker=2 --scale anchor-worker=2
python -m agentdance.cli evaluate \
