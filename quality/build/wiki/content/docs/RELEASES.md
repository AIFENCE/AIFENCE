...
Stable 2.0 performance evidence is documented in [`PERFORMANCE_EVIDENCE.md`](PERFORMANCE_EVIDENCE.md). The current external-value benchmark reports **96.800/100 for AIFENCE 2.0**, **85.867/100 for a strong handcrafted production prompt**, and **65.200/100 for brief-only/default generation**, with AIFENCE winning 30/30 paired comparisons against both baselines under the locked same-environment engineering protocol.
