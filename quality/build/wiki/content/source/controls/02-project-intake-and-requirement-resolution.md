...
# 02. Project Intake & Requirement Resolution
<!-- id: controls.domain.02 -->
...
<!-- id: controls.domain.02.execution -->
...
## Unknown-fact policy
<!-- id: controls.capability.unknown-fact-policy -->

**Targets:** PROJECT_TEMPLATE.md / TERMINOLOGY.md  
**Requirement:** Prevent invented business facts, credentials, addresses, prices, testimonials, guarantees, or operational claims.

### Contract — BQ-0046
<!-- id: control.bq-0046 -->

- **MUST:** Prevent invented business facts, credentials, addresses, prices, testimonials, guarantees, or operational claims.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Prevent invented business facts, credentials, addresses, prices, testimonials, guarantees, or operational claims.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0048
<!-- id: control.bq-0048 -->
...
<!-- id: controls.capability.constraint-normalization -->

**Targets:** PROJECT_TEMPLATE.md  
**Requirement:** Normalize free-form user constraints into explicit technical, visual, legal, content, asset, and delivery constraints.

### Contract — BQ-0051
<!-- id: control.bq-0051 -->

- **MUST:** Normalize free-form user constraints into explicit technical, visual, legal, content, asset, and delivery constraints.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Normalize free-form user constraints into explicit technical, visual, legal, content, asset, and delivery constraints.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0053
<!-- id: control.bq-0053 -->
...
## Goal hierarchy
<!-- id: controls.capability.goal-hierarchy -->

**Targets:** PROJECT_TEMPLATE.md  
**Requirement:** Rank primary business goal, primary user goal, secondary goals, and non-goals so design tradeoffs have a stable decision basis.

### Contract — BQ-0056
<!-- id: control.bq-0056 -->

- **MUST:** Rank primary business goal, primary user goal, secondary goals, and non-goals so design tradeoffs have a stable decision basis.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Rank primary business goal, primary user goal, secondary goals, and non-goals so design tradeoffs have a stable decision basis.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0058
<!-- id: control.bq-0058 -->
...
## Audience resolution
<!-- id: controls.capability.audience-resolution -->

**Targets:** PROJECT_TEMPLATE.md / PROFILE_MATRIX.md  
**Requirement:** Resolve primary audience, secondary audience, buyer-user differences, sophistication, urgency, and trust needs.

### Contract — BQ-0061
<!-- id: control.bq-0061 -->

- **MUST:** Resolve primary audience, secondary audience, buyer-user differences, sophistication, urgency, and trust needs.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Resolve primary audience, secondary audience, buyer-user differences, sophistication, urgency, and trust needs.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0063
<!-- id: control.bq-0063 -->
...
## Scope boundary
<!-- id: controls.capability.scope-boundary -->

**Targets:** PROJECT_TEMPLATE.md / README.md  
**Requirement:** Define what must be complete, what is explicitly excluded, and what cannot be fabricated or simulated.

### Contract — BQ-0066
<!-- id: control.bq-0066 -->

- **MUST:** Define what must be complete, what is explicitly excluded, and what cannot be fabricated or simulated.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define what must be complete, what is explicitly excluded, and what cannot be fabricated or simulated.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0068
<!-- id: control.bq-0068 -->
...
## Assumption register
<!-- id: controls.capability.assumption-register -->

**Targets:** PROJECT_TEMPLATE.md  
**Requirement:** Record material assumptions with confidence and impact so hidden guesses cannot masquerade as requirements.

### Contract — BQ-0071
<!-- id: control.bq-0071 -->

- **MUST:** Record material assumptions with confidence and impact so hidden guesses cannot masquerade as requirements.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Record material assumptions with confidence and impact so hidden guesses cannot masquerade as requirements.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0073
<!-- id: control.bq-0073 -->
...
<!-- id: controls.capability.requirement-change-propagation -->

**Targets:** README.md  
**Requirement:** When a user changes one requirement, recompute only dependent decisions and preserve unrelated resolved state.

### Contract — BQ-0076
<!-- id: control.bq-0076 -->

- **MUST:** When a user changes one requirement, recompute only dependent decisions and preserve unrelated resolved state.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: When a user changes one requirement, recompute only dependent decisions and preserve unrelated resolved state.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0078
<!-- id: control.bq-0078 -->
