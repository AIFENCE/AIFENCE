...
# 21. Performance, Reliability & Resource Budgets
<!-- id: controls.domain.21 -->
...
<!-- id: controls.domain.21.execution -->
...
<!-- id: controls.capability.performance-budget-declaration -->

**Targets:** CREATIVE.md / QA_GATES.md  
**Requirement:** Set explicit budgets for initial transfer, images, fonts, JavaScript, CSS, third-party scripts, and key rendering metrics by project class.

### Contract — BQ-0801
<!-- id: control.bq-0801 -->

- **MUST:** Set explicit budgets for initial transfer, images, fonts, JavaScript, CSS, third-party scripts, and key rendering metrics by project class.
...
3. Apply the requirement exactly: Set explicit budgets for initial transfer, images, fonts, JavaScript, CSS, third-party scripts, and key rendering metrics by project class.
...
<!-- id: controls.capability.critical-path-minimization -->

**Targets:** ASSETS.md / DESIGN.md  
**Requirement:** Prioritize resources required for first meaningful content and defer noncritical media, scripts, and effects.

### Contract — BQ-0806
<!-- id: control.bq-0806 -->

- **MUST:** Prioritize resources required for first meaningful content and defer noncritical media, scripts, and effects.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Prioritize resources required for first meaningful content and defer noncritical media, scripts, and effects.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0808
<!-- id: control.bq-0808 -->
...
<!-- id: controls.capability.font-performance-strategy -->

**Targets:** CREATIVE.md / DESIGN.md  
**Requirement:** Limit font families, weights, subsets, and blocking behavior while preserving the resolved brand character.

### Contract — BQ-0816
<!-- id: control.bq-0816 -->

- **MUST:** Limit font families, weights, subsets, and blocking behavior while preserving the resolved brand character.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Limit font families, weights, subsets, and blocking behavior while preserving the resolved brand character.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0818
<!-- id: control.bq-0818 -->
...
<!-- id: controls.capability.graceful-degradation-behavior -->

**Targets:** FEATURES.md  
**Requirement:** Define what still works when optional assets, APIs, scripts, or external services fail.

### Contract — BQ-0826
<!-- id: control.bq-0826 -->

- **MUST:** Define what still works when optional assets, APIs, scripts, or external services fail.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define what still works when optional assets, APIs, scripts, or external services fail.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0828
<!-- id: control.bq-0828 -->
...
## Long-task responsiveness
<!-- id: controls.capability.long-task-responsiveness -->

**Targets:** FEATURES.md / DESIGN.md  
**Requirement:** Use progress, optimistic feedback, cancellation, background processing, or chunking appropriate to task duration and risk.

### Contract — BQ-0831
<!-- id: control.bq-0831 -->

- **MUST:** Use progress, optimistic feedback, cancellation, background processing, or chunking appropriate to task duration and risk.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Use progress, optimistic feedback, cancellation, background processing, or chunking appropriate to task duration and risk.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0833
<!-- id: control.bq-0833 -->
...
<!-- id: controls.capability.performance-regression-gate -->

**Targets:** QA_GATES.md  
**Requirement:** Compare final output against declared budgets and reject avoidable regressions introduced by decorative or low-value features.

### Contract — BQ-0836
<!-- id: control.bq-0836 -->

- **MUST:** Compare final output against declared budgets and reject avoidable regressions introduced by decorative or low-value features.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Compare final output against declared budgets and reject avoidable regressions introduced by decorative or low-value features.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0838
<!-- id: control.bq-0838 -->
