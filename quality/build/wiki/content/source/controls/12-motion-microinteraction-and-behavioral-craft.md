...
# 12. Motion, Microinteraction & Behavioral Craft
<!-- id: controls.domain.12 -->
...
<!-- id: controls.domain.12.execution -->
...
<!-- id: controls.capability.motion-purpose-taxonomy -->

**Targets:** CREATIVE.md / DESIGN.md  
**Requirement:** Classify motion as orientation, causality, feedback, continuity, emphasis, delight, or status and reject motion without a purpose.

### Contract — BQ-0441
<!-- id: control.bq-0441 -->

- **MUST:** Classify motion as orientation, causality, feedback, continuity, emphasis, delight, or status and reject motion without a purpose.
...
3. Apply the requirement exactly: Classify motion as orientation, causality, feedback, continuity, emphasis, delight, or status and reject motion without a purpose.
...
<!-- id: controls.capability.animation-duration-tokens -->

**Targets:** DESIGN.md  
**Requirement:** Define bounded duration and easing tokens for micro, standard, complex, and page-transition motion.

### Contract — BQ-0446
<!-- id: control.bq-0446 -->

- **MUST:** Define bounded duration and easing tokens for micro, standard, complex, and page-transition motion.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define bounded duration and easing tokens for micro, standard, complex, and page-transition motion.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0448
<!-- id: control.bq-0448 -->
...
<!-- id: controls.capability.interaction-state-completeness -->

**Targets:** DESIGN.md / FEATURES.md  
**Requirement:** Specify default, hover, focus, active, selected, disabled, loading, success, error, and destructive states for interactive components.

### Contract — BQ-0451
<!-- id: control.bq-0451 -->

- **MUST:** Specify default, hover, focus, active, selected, disabled, loading, success, error, and destructive states for interactive components.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Specify default, hover, focus, active, selected, disabled, loading, success, error, and destructive states for interactive components.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0453
<!-- id: control.bq-0453 -->
...
<!-- id: controls.capability.reduced-motion-equivalence -->

**Targets:** CREATIVE.md / QA_GATES.md  
**Requirement:** Ensure reduced-motion users retain orientation, feedback, and task clarity rather than simply losing animated cues.

### Contract — BQ-0456
<!-- id: control.bq-0456 -->

- **MUST:** Ensure reduced-motion users retain orientation, feedback, and task clarity rather than simply losing animated cues.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Ensure reduced-motion users retain orientation, feedback, and task clarity rather than simply losing animated cues.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0458
<!-- id: control.bq-0458 -->
...
## Scroll-animation restraint
<!-- id: controls.capability.scroll-animation-restraint -->

**Targets:** CREATIVE.md  
**Requirement:** Limit reveal-on-scroll effects so they do not become the primary source of visual interest or delay content comprehension.

### Contract — BQ-0461
<!-- id: control.bq-0461 -->

- **MUST:** Limit reveal-on-scroll effects so they do not become the primary source of visual interest or delay content comprehension.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Limit reveal-on-scroll effects so they do not become the primary source of visual interest or delay content comprehension.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0463
<!-- id: control.bq-0463 -->
...
## Feedback latency standard
<!-- id: controls.capability.feedback-latency-standard -->

**Targets:** DESIGN.md / FEATURES.md  
**Requirement:** Provide immediate perceived feedback for user actions even when underlying work takes longer.

### Contract — BQ-0466
<!-- id: control.bq-0466 -->

- **MUST:** Provide immediate perceived feedback for user actions even when underlying work takes longer.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Provide immediate perceived feedback for user actions even when underlying work takes longer.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0468
<!-- id: control.bq-0468 -->
...
<!-- id: controls.capability.gesture-discoverability -->

**Targets:** DESIGN.md  
**Requirement:** Avoid gesture-only interactions unless an accessible visible control or clear affordance also exists.

### Contract — BQ-0471
<!-- id: control.bq-0471 -->

- **MUST:** Avoid gesture-only interactions unless an accessible visible control or clear affordance also exists.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Avoid gesture-only interactions unless an accessible visible control or clear affordance also exists.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0473
<!-- id: control.bq-0473 -->
