<!-- GENERATED from source/controls/06-research-benchmarking-and-reference-intelligence.md#controls.capability.research-to-design-linkage; canonical truth remains source/. -->
