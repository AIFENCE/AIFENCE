<!-- GENERATED from source/controls/27-artifact-contracts-and-specification-compilation.md#controls.capability.artifact-contract-resolution; canonical truth remains source/. -->

## Artifact Contract Resolution
<!-- id: controls.capability.artifact-contract-resolution -->

**Targets:** ARTIFACT_CONTRACTS.md / contracts/*  
**Requirement:** Resolve the narrowest applicable artifact production contract before substantial feature, design, or implementation work begins.

### Contract — BQ-1051
<!-- id: control.bq-1051 -->

- **MUST:** Resolve the narrowest applicable artifact production contract before substantial feature, design, or implementation work begins.
