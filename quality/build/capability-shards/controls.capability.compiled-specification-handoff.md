<!-- GENERATED from source/controls/27-artifact-contracts-and-specification-compilation.md#controls.capability.compiled-specification-handoff; canonical truth remains source/. -->

## Compiled Specification Handoff
<!-- id: controls.capability.compiled-specification-handoff -->

**Targets:** ARTIFACT_CONTRACTS.md / FEATURE_COMPILER.md / COMPONENT_COMPILER.md  
**Requirement:** Require implementation to consume resolved artifact, feature, and component specifications without silently changing product behavior or quality targets for convenience.

### Contract — BQ-1096
<!-- id: control.bq-1096 -->

- **MUST:** Require implementation to consume resolved artifact, feature, and component specifications without silently changing product behavior or quality targets for convenience.
