<!-- GENERATED from source/controls/27-artifact-contracts-and-specification-compilation.md#controls.capability.feature-information-action-model; canonical truth remains source/. -->

## Feature Information Action Model
<!-- id: controls.capability.feature-information-action-model -->

**Targets:** FEATURE_COMPILER.md / schemas/feature_spec.schema.json  
**Requirement:** Resolve information priority plus primary, secondary, contextual, validation, recovery, and destructive actions so implementation does not invent feature behavior.

### Contract — BQ-1066
<!-- id: control.bq-1066 -->

- **MUST:** Resolve information priority plus primary, secondary, contextual, validation, recovery, and destructive actions so implementation does not invent feature behavior.
