<!-- GENERATED from source/controls/27-artifact-contracts-and-specification-compilation.md#controls.capability.artifact-contract-completeness; canonical truth remains source/. -->

## Artifact Contract Completeness
<!-- id: controls.capability.artifact-contract-completeness -->

**Targets:** contracts/* / QUALITY_FLOORS.md  
**Requirement:** Ensure the selected artifact contract defines user jobs, required information/feature/state outcomes, truth boundaries, responsive/accessibility obligations, evidence, and acceptance profile.

### Contract — BQ-1056
<!-- id: control.bq-1056 -->

- **MUST:** Ensure the selected artifact contract defines user jobs, required information/feature/state outcomes, truth boundaries, responsive/accessibility obligations, evidence, and acceptance profile.
