<!-- GENERATED from source/controls/13-responsive-mobile-and-cross-device-design.md#controls.capability.breakpoint-rationale; canonical truth remains source/. -->
