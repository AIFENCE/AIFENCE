<!-- GENERATED from source/controls/27-artifact-contracts-and-specification-compilation.md#controls.capability.user-job-state-data-model; canonical truth remains source/. -->

## User Job State Data Model
<!-- id: controls.capability.user-job-state-data-model -->

**Targets:** FEATURE_COMPILER.md / FEATURES.md / STRUCTURE.md  
**Requirement:** Link each high-value feature to an explicit user job, required data/truth semantics, and applicable state model including edge and recovery states.

### Contract — BQ-1071
<!-- id: control.bq-1071 -->

- **MUST:** Link each high-value feature to an explicit user job, required data/truth semantics, and applicable state model including edge and recovery states.
