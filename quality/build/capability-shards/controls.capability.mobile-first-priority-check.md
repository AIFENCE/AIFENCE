<!-- GENERATED from source/controls/13-responsive-mobile-and-cross-device-design.md#controls.capability.mobile-first-priority-check; canonical truth remains source/. -->
