...
# 25. Pack Governance, Versioning, Evals & Self-Improvement
<!-- id: controls.domain.25 -->
...
<!-- id: controls.domain.25.execution -->
...
<!-- id: controls.capability.stable-rule-identifiers -->

**Targets:** MANIFEST.md  
**Requirement:** Give major standards stable IDs so tests, project state, and future versions can reference rules without fragile heading text.

### Contract — BQ-0966
<!-- id: control.bq-0966 -->

- **MUST:** Give major standards stable IDs so tests, project state, and future versions can reference rules without fragile heading text.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Give major standards stable IDs so tests, project state, and future versions can reference rules without fragile heading text.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0968
<!-- id: control.bq-0968 -->
...
<!-- id: controls.capability.semantic-version-policy -->

**Targets:** README.md / MANIFEST.md  
**Requirement:** Define which changes require major, minor, or patch version increments and enforce consistency across module metadata.

### Contract — BQ-0971
<!-- id: control.bq-0971 -->

- **MUST:** Define which changes require major, minor, or patch version increments and enforce consistency across module metadata.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define which changes require major, minor, or patch version increments and enforce consistency across module metadata.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0973
<!-- id: control.bq-0973 -->
...
## Migration notes
<!-- id: controls.capability.migration-notes -->

**Targets:** README.md  
**Requirement:** For behavior-changing releases, document changed rules, renamed IDs, new defaults, regressions addressed, and compatibility implications.

### Contract — BQ-0976
<!-- id: control.bq-0976 -->

- **MUST:** For behavior-changing releases, document changed rules, renamed IDs, new defaults, regressions addressed, and compatibility implications.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: For behavior-changing releases, document changed rules, renamed IDs, new defaults, regressions addressed, and compatibility implications.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0978
<!-- id: control.bq-0978 -->
...
## Pack-lint coverage
<!-- id: controls.capability.pack-lint-coverage -->

**Targets:** tools/validate_pack.py  
**Requirement:** Expand validation beyond IDs to references, dependencies, metadata, orphan sections, contradictory defaults, broken file paths, and stale version strings.

### Contract — BQ-0981
<!-- id: control.bq-0981 -->

- **MUST:** Expand validation beyond IDs to references, dependencies, metadata, orphan sections, contradictory defaults, broken file paths, and stale version strings.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Expand validation beyond IDs to references, dependencies, metadata, orphan sections, contradictory defaults, broken file paths, and stale version strings.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0983
<!-- id: control.bq-0983 -->
...
<!-- id: controls.capability.prompt-regression-benchmark -->

**Targets:** QA_GATES.md  
**Requirement:** Maintain scored benchmark prompts representing websites, apps, documents, strategy, operations, regulated domains, ambiguous businesses, and asset-heavy tasks.

### Contract — BQ-0986
<!-- id: control.bq-0986 -->

- **MUST:** Maintain scored benchmark prompts representing websites, apps, documents, strategy, operations, regulated domains, ambiguous businesses, and asset-heavy tasks.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Maintain scored benchmark prompts representing websites, apps, documents, strategy, operations, regulated domains, ambiguous businesses, and asset-heavy tasks.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0988
<!-- id: control.bq-0988 -->
...
## Rule-pruning discipline
<!-- id: controls.capability.rule-pruning-discipline -->

**Targets:** MANIFEST.md / README.md  
**Requirement:** Periodically remove redundant, low-value, obsolete, or unenforceable instructions so added quality does not create context bloat and contradiction.

### Contract — BQ-0996
<!-- id: control.bq-0996 -->

- **MUST:** Periodically remove redundant, low-value, obsolete, or unenforceable instructions so added quality does not create context bloat and contradiction.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Periodically remove redundant, low-value, obsolete, or unenforceable instructions so added quality does not create context bloat and contradiction.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0998
<!-- id: control.bq-0998 -->
