...
# 05. Creation-Type Routing & Deliverable Semantics
<!-- id: controls.domain.05 -->
...
<!-- id: controls.domain.05.execution -->
...
## Hybrid-deliverable routing
<!-- id: controls.capability.hybrid-deliverable-routing -->

**Targets:** README.md / MANIFEST.md  
**Requirement:** Support requests spanning multiple artifact types without dropping standards belonging to secondary deliverables.

### Contract — BQ-0166
<!-- id: control.bq-0166 -->

- **MUST:** Support requests spanning multiple artifact types without dropping standards belonging to secondary deliverables.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Support requests spanning multiple artifact types without dropping standards belonging to secondary deliverables.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0168
<!-- id: control.bq-0168 -->
...
## Front-end-only semantics
<!-- id: controls.capability.front-end-only-semantics -->

**Targets:** README.md / FEATURES.md  
**Requirement:** Define exactly what front-end-only means for forms, auth, persistence, APIs, integrations, and simulated states.

### Contract — BQ-0171
<!-- id: control.bq-0171 -->

- **MUST:** Define exactly what front-end-only means for forms, auth, persistence, APIs, integrations, and simulated states.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define exactly what front-end-only means for forms, auth, persistence, APIs, integrations, and simulated states.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0173
<!-- id: control.bq-0173 -->
...
## Production-vs-concept distinction
<!-- id: controls.capability.production-vs-concept-distinction -->

**Targets:** README.md / CREATIVE.md  
**Requirement:** Distinguish high-fidelity concept imagery from production software without lowering the visual bar for either.

### Contract — BQ-0176
<!-- id: control.bq-0176 -->

- **MUST:** Distinguish high-fidelity concept imagery from production software without lowering the visual bar for either.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Distinguish high-fidelity concept imagery from production software without lowering the visual bar for either.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0178
<!-- id: control.bq-0178 -->
...
<!-- id: controls.capability.artifact-format-constraints -->

**Targets:** README.md  
**Requirement:** Route based on requested final file format and ensure the implementation method can actually produce that artifact.

### Contract — BQ-0181
<!-- id: control.bq-0181 -->

- **MUST:** Route based on requested final file format and ensure the implementation method can actually produce that artifact.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Route based on requested final file format and ensure the implementation method can actually produce that artifact.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0183
<!-- id: control.bq-0183 -->
...
## Creation-specific mandatory modules
<!-- id: controls.capability.creation-specific-mandatory-modules -->

**Targets:** MANIFEST.md  
**Requirement:** Make required module dependencies machine-checkable for every creation type rather than advisory prose.

### Contract — BQ-0186
<!-- id: control.bq-0186 -->

- **MUST:** Make required module dependencies machine-checkable for every creation type rather than advisory prose.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Make required module dependencies machine-checkable for every creation type rather than advisory prose.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0188
<!-- id: control.bq-0188 -->
...
## Creation-type forbidden shortcuts
<!-- id: controls.capability.creation-type-forbidden-shortcuts -->

**Targets:** README.md / QA_GATES.md  
**Requirement:** Define shortcuts that are specifically invalid for each creation type, such as fake dashboards, dead forms, or unimplemented primary flows.

### Contract — BQ-0191
<!-- id: control.bq-0191 -->

- **MUST:** Define shortcuts that are specifically invalid for each creation type, such as fake dashboards, dead forms, or unimplemented primary flows.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Define shortcuts that are specifically invalid for each creation type, such as fake dashboards, dead forms, or unimplemented primary flows.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0193
<!-- id: control.bq-0193 -->
