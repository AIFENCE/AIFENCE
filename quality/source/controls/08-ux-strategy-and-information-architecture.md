...
# 08. UX Strategy & Information Architecture
<!-- id: controls.domain.08 -->
...
<!-- id: controls.domain.08.execution -->
...
<!-- id: controls.capability.primary-task-mapping -->

**Targets:** STRUCTURE.md / FEATURES.md  
**Requirement:** Identify the highest-value user tasks and ensure architecture, navigation, and calls to action prioritize them.

### Contract — BQ-0281
<!-- id: control.bq-0281 -->

- **MUST:** Identify the highest-value user tasks and ensure architecture, navigation, and calls to action prioritize them.
...
3. Apply the requirement exactly: Identify the highest-value user tasks and ensure architecture, navigation, and calls to action prioritize them.
...
## Journey-state model
<!-- id: controls.capability.journey-state-model -->

**Targets:** STRUCTURE.md / FEATURES.md  
**Requirement:** Model discovery, evaluation, conversion, onboarding, use, recovery, and retention states where applicable.

### Contract — BQ-0286
<!-- id: control.bq-0286 -->

- **MUST:** Model discovery, evaluation, conversion, onboarding, use, recovery, and retention states where applicable.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Model discovery, evaluation, conversion, onboarding, use, recovery, and retention states where applicable.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0288
<!-- id: control.bq-0288 -->
...
<!-- id: controls.capability.content-priority-hierarchy -->

**Targets:** STRUCTURE.md  
**Requirement:** Rank proof, benefits, features, details, objections, and conversion elements according to user decision sequence.

### Contract — BQ-0296
<!-- id: control.bq-0296 -->

- **MUST:** Rank proof, benefits, features, details, objections, and conversion elements according to user decision sequence.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Rank proof, benefits, features, details, objections, and conversion elements according to user decision sequence.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0298
<!-- id: control.bq-0298 -->
...
## Navigation complexity budget
<!-- id: controls.capability.navigation-complexity-budget -->

**Targets:** STRUCTURE.md  
**Requirement:** Set limits on top-level choices and progressive disclosure based on task complexity and audience expertise.

### Contract — BQ-0301
<!-- id: control.bq-0301 -->

- **MUST:** Set limits on top-level choices and progressive disclosure based on task complexity and audience expertise.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Set limits on top-level choices and progressive disclosure based on task complexity and audience expertise.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0303
<!-- id: control.bq-0303 -->
...
<!-- id: controls.capability.edge-state-architecture -->

**Targets:** STRUCTURE.md / FEATURES.md  
**Requirement:** Include empty, error, loading, permission, offline, no-result, expired, and destructive-action states in architecture when relevant.

### Contract — BQ-0306
<!-- id: control.bq-0306 -->

- **MUST:** Include empty, error, loading, permission, offline, no-result, expired, and destructive-action states in architecture when relevant.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Include empty, error, loading, permission, offline, no-result, expired, and destructive-action states in architecture when relevant.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0308
<!-- id: control.bq-0308 -->
...
<!-- id: controls.capability.cross-page-continuity -->

**Targets:** STRUCTURE.md  
**Requirement:** Preserve vocabulary, CTA semantics, hierarchy, and user state across pages instead of treating each page as an isolated composition.

### Contract — BQ-0311
<!-- id: control.bq-0311 -->

- **MUST:** Preserve vocabulary, CTA semantics, hierarchy, and user state across pages instead of treating each page as an isolated composition.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Preserve vocabulary, CTA semantics, hierarchy, and user state across pages instead of treating each page as an isolated composition.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0313
<!-- id: control.bq-0313 -->
...
## IA validation scenarios
<!-- id: controls.capability.ia-validation-scenarios -->

**Targets:** QA_GATES.md  
**Requirement:** Test representative user goals against the proposed structure and fail designs that require unnecessary backtracking or hidden knowledge.

### Contract — BQ-0316
<!-- id: control.bq-0316 -->

- **MUST:** Test representative user goals against the proposed structure and fail designs that require unnecessary backtracking or hidden knowledge.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Test representative user goals against the proposed structure and fail designs that require unnecessary backtracking or hidden knowledge.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0318
<!-- id: control.bq-0318 -->
