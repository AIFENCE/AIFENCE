...
# 15. Content, Copy & Terminology
<!-- id: controls.domain.15 -->
...
<!-- id: controls.domain.15.execution -->
...
<!-- id: controls.capability.claim-evidence-pairing -->

**Targets:** TERMINOLOGY.md / LEGAL.md  
**Requirement:** Require factual, comparative, performance, safety, expertise, and outcome claims to have appropriate evidence or softer wording.

### Contract — BQ-0571
<!-- id: control.bq-0571 -->

- **MUST:** Require factual, comparative, performance, safety, expertise, and outcome claims to have appropriate evidence or softer wording.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Require factual, comparative, performance, safety, expertise, and outcome claims to have appropriate evidence or softer wording.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0573
<!-- id: control.bq-0573 -->
...
## CTA semantic specificity
<!-- id: controls.capability.cta-semantic-specificity -->

**Targets:** TERMINOLOGY.md / CREATIVE.md  
**Requirement:** Prefer action labels that describe the next step and expected outcome rather than generic labels such as Learn More.

### Contract — BQ-0576
<!-- id: control.bq-0576 -->

- **MUST:** Prefer action labels that describe the next step and expected outcome rather than generic labels such as Learn More.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Prefer action labels that describe the next step and expected outcome rather than generic labels such as Learn More.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0578
<!-- id: control.bq-0578 -->
...
<!-- id: controls.capability.content-density-control -->

**Targets:** TERMINOLOGY.md / DESIGN.md  
**Requirement:** Match copy length to decision complexity, scan patterns, viewport, and component role instead of maximizing brevity everywhere.

### Contract — BQ-0581
<!-- id: control.bq-0581 -->

- **MUST:** Match copy length to decision complexity, scan patterns, viewport, and component role instead of maximizing brevity everywhere.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Match copy length to decision complexity, scan patterns, viewport, and component role instead of maximizing brevity everywhere.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0583
<!-- id: control.bq-0583 -->
...
<!-- id: controls.capability.terminology-registry -->

**Targets:** TERMINOLOGY.md  
**Requirement:** Maintain preferred terms, forbidden synonyms, capitalization, abbreviations, product names, and role names for the project.

### Contract — BQ-0586
<!-- id: control.bq-0586 -->

- **MUST:** Maintain preferred terms, forbidden synonyms, capitalization, abbreviations, product names, and role names for the project.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Maintain preferred terms, forbidden synonyms, capitalization, abbreviations, product names, and role names for the project.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0588
<!-- id: control.bq-0588 -->
...
## Microcopy state coverage
<!-- id: controls.capability.microcopy-state-coverage -->

**Targets:** TERMINOLOGY.md / FEATURES.md  
**Requirement:** Author production-quality copy for loading, empty, error, success, destructive, permission, and recovery states.

### Contract — BQ-0591
<!-- id: control.bq-0591 -->

- **MUST:** Author production-quality copy for loading, empty, error, success, destructive, permission, and recovery states.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Author production-quality copy for loading, empty, error, success, destructive, permission, and recovery states.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0593
<!-- id: control.bq-0593 -->
...
<!-- id: controls.capability.content-realism-gate -->

**Targets:** CREATIVE.md / QA_GATES.md  
**Requirement:** Reject lorem ipsum, vague filler, fake metrics, fake testimonials, fake logos, and unnaturally generic marketing copy.

### Contract — BQ-0596
<!-- id: control.bq-0596 -->

- **MUST:** Reject lorem ipsum, vague filler, fake metrics, fake testimonials, fake logos, and unnaturally generic marketing copy.
- Required inputs are the minimum task/project facts on which this decision depends; missing facts must remain explicitly unknown rather than invented.
- Required output is a concrete decision, state, artifact property, or constraint that downstream work can consume.
- Invariants: higher-precedence instructions remain controlling; production intent cannot be silently weakened; fabricated evidence is prohibited.
- Prohibited shortcut: treating an unverified assumption, keyword match, generic template pattern, or model confidence as satisfaction.
...
1. Determine whether this capability is triggered by the current scope or by a dependency of another active capability.
2. Gather the minimum relevant evidence before selecting a result; distinguish known, inferred, and unknown inputs.
3. Apply the requirement exactly: Reject lorem ipsum, vague filler, fake metrics, fake testimonials, fake logos, and unnaturally generic marketing copy.
4. Resolve ties using README precedence, business/user goal fit, risk, and the most conservative non-fabricating fallback in that order.
5. Persist the result in the project decision state or artifact evidence ledger when later work depends on it.
6. Re-evaluate when scope, audience, industry, feature set, risk, delivery mode, or evidence materially changes.

### Evidence Gate — BQ-0598
<!-- id: control.bq-0598 -->
