import test from 'node:test';import assert from 'node:assert/strict';import fs from 'node:fs';import {AifenceRouter} from '../src/router.js';import {classifyRequest} from '../src/classifier.js';const r=new AifenceRouter();
