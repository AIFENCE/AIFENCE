...
|---|---|---|---|
| Generic Agent Skills | `.agents/skills/aifence` | host-specific | `adapters/generic` |
...
| VS Code Copilot | `.agents/skills/aifence` | `.vscode/mcp.json` | config template |
| Cursor | MCP-first | `.cursor/mcp.json` | config template |
| OpenAI / Codex | `.agents/skills/aifence` where supported | remote MCP for API | example + skill installer |
